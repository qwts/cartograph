...
| T-0015 | AC-0015 | rust | flowtracer::hops_record_tier_across_the_full_chain, flowtracer::orphan_channel_is_a_trigger_published_channel_is_not, flowtracer::screen_anchored_flow_walks_the_full_chain, flowtracer::unfetched_endpoints_remain_triggers | Screen anchor at M4 (T1–T3 rungs join M6–M8), plus manual:MT-M4-01 |
