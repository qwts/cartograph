...
| T-0022 | AC-0022 | rust | semantic::paired_eval_gates_best_effort_overlay, semantic::failed_precision_gate_exports_no_semantic_links, app::semantic_preview_fills_only_eval_gated_gap_overlay, app::eval_results_survive_reopen | positive+negative pair calibration; aggregate precision + per-link threshold fail closed; operating point durable, plus manual:MT-M7-01 |
