...
| T-0014 | AC-0014 | rust | events::resolvable_fetch_urls_confirm_against_endpoints, events::unresolvable_fetches_emit_gaps_with_reasons, adapters-lang-ts::fetch_and_axios_sites_are_detected_and_classified | exact + :param template match; Gap on computed/no-match/ambiguous |
