...
After merging the 0.12.0 release, two more fresh runs at `5e4eb4ba69b6fa67d150d4b2af3a05d16bc7144f` (`vendure-local-definitions-final-3` and `vendure-local-definitions-final-4`) reproduced all four artifacts exactly. Both repeated audits also matched the recorded audit bytes. Input membership, file hashes and the oracle remained unchanged.
