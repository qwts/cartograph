...
test('CI enforces the governed lifecycle without draft jobs', () => {
  ...
  assert.match(
    workflow,
    /qwts\/playbook-engineering\/\.github\/actions\/ci-policy@6dd8ae2877fc919c21a6224e8a9954bd8e12ee5d/u,
  );
...
test('direct non-CI entrypoints authorize before checkout and reusable calls inherit policy', () => {
  ...
  for (const workflow of workflows) {
    assert.match(workflow, /ci-policy@6dd8ae2877fc919c21a6224e8a9954bd8e12ee5d/u);
