...
| T-0021 | AC-0021 | rust | semantic::semantic_proposals_are_inferred_strong_and_cite_both_sides, semantic::semantic_resolver_handles_explicit_call_gaps, semantic::usearch_returns_cosine_nearest_neighbor, llm::ollama_embed_uses_batch_api_and_validates_response, llm::local_provider_rejects_non_loopback_endpoints, llm::unavailable_local_provider_fails_without_fallback, app::semantic_preview_fills_only_eval_gated_gap_overlay | explicit channel/call Gap slots only; staged Semantic/InferredStrong links cite both sides; local provider fails closed |
